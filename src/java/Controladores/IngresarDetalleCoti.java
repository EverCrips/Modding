 ...
 * @author Ignacio
 */
public class IngresarDetalleCoti extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String fecha= request.getParameter("fechaDetalle");
            String estadoDetalle= request.getParameter("estadoDetalle");
            String descripcionCoti= request.getParameter("descripcionDetalle");
            String idcotizacionDetalle= request.getParameter("idcotizacionDetalle");
            
            
            if(co.registrarCotiDetalle(java.sql.Date.valueOf(fecha), estadoDetalle, descripcionCoti, idcotizacionDetalle)){
