<%@page import="Modelos.ConsultrasAdministrador"%>
    ...
    //String categoriaUsuario = (String) sesion.getAttribute("categoriaUsuario");
        ...
        //if (categoriaUsuario != null) {
            ...
            //if (categoriaUsuario.equals("ADMINISTRADOR")) {
                ...
                //String nombre = (String)sesion.getAttribute("nick");
                //String ID_nombre=(String)sesion.getAttribute("id");
            
                //String Nombre= (String)request.getAttribute("numeroCotizacion");
                //String fnac= (String)request.getAttribute("estadoCotizacion");
                //String especie= (String)request.getAttribute("nombreCotizacion");
                //String raza= (String)request.getAttribute("descripcionCotizacion");
                //String direccion= (String)request.getAttribute("idUsuarioCotizacion");
        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <section>
                        <header class="main">
                            <h1> Ventas Cliente</h1>
                        </header>
                        
                        
                            <form method="post" action="buscardetallecoti">
                                <div class="features">

                                    <div class="12u">
                                            <br>
                                            <small class="form-text text-muted">
                                                Ingrese la ID de la cotizacion a buscar
                                            </small>
                                            <br>
                                            <ul>
                                            <input type="text" name="ID" id="ID" value="" placeholder="ID COTIZACION " required/>
                                            <br>
                                            </ul>
                                            <ul class="actions">
					...
					<table data-vertable="ver2">
						<thead>
							<tr class="row100 head">
								<th class="column100 column1" data-column="column1">Id Cotiza</th>
								<th class="column100 column2" data-column="column2">Estado Cotizacion</th>
								<th class="column100 column3" data-column="column3">Nombre Cotizacion</th>
                                                                <th class="column100 column4" data-column="column4">Descripción Cotizacion</th>
                                                                <th class="column100 column5" data-column="column5">Usuario Cotizacion</th>
                                                                <th class="column100 column6" data-column="column5">Monto Cotizacion</th>
							</tr>
						</thead>
						<tbody>
                                                        <%int j=0;%>
							...
							<tr class="row100">
								...
								<td class="column100 column5" data-column="column5"><%=listaDates.get(j+(i))%></td>
                                                                <%j=j+1; %>
								<td class="column100 column6" data-column="column5"><%=listaDates.get(j+(i))%></td>
							</tr>
                                                        <%}%>
						</tbody>
					</table>
                    ...
                    <h5>Ingresar Cotizacion</h5>
                        <form method="post" action="IngresarCoti">
                            <hr>
                            <div class="features">
                                    ...
                                    <div class="row uniform">
                                        <div class="10u">
                                            ...
                                            <input type="text" name="estadoCoti" id="estadoCoti" value="" placeholder="" />
                                        </div>  
                                        <div class="10u">
                                            <small class="form-text text-muted">
                                                   Nombre Cotizacion
                                            </small>
                                            <input type="text" name="nombreCoti" id="nombreCoti" value="" placeholder="" />
                                        </div>
                                        <div class="10u">
                                            <small class="form-text text-muted">
                                                   Descripcion Cotizacion
                                            </small>
                                            <input type="text" name="descripcionCoti" id="descripcionCoti" value="" placeholder="" />
                                        </div>
                                        <div class="10u">
                                            <small class="form-text text-muted">
                                                   Usuario Cotizacion
                                            </small>
                                            <input type="text" name="usuarioCoti" id="UsuarioCoti" value="" placeholder="" />
                                        </div>
                                        <div class="10u">
                                            <small class="form-text text-muted">
                                                   Monto Cotizacion
                                            </small>
                                            <input type="text" name="montoCoti" id="montoCoti" value="" placeholder="" />
                                        </div>
                                   </div>
                                   <div class="12u">
                                       <br>
