...
jQuery(document).ready(function () {
	...
	var iRegion = 0;
	var htmlRegion = '<option value="sin-region">**Seleccionar**</option>';
	var htmlComunas = '<option value="sin-region">**Seleccionar**</option>';
	...
	jQuery('#regiones').change(function () {
		...
		var htmlComuna = '<option value="sin-comuna">**Seleccionar**</option>';
		jQuery.each(RegionesYcomunas.regiones, function () {
