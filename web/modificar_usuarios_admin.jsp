            ...
            <div id="main">
                <div class="inner">
                    ...
                    <section>
                        ...
                        <div id="containerino">
                            <!-- FORMULARIO -->
                            <form method="post" action="ModifiUsuarioAdmin" name="form1">
                                <div class="posts">
                                <article> 
                                    ...
                                    <div class="row uniform">
                                        ...
                                        <div class="10u">
                                            ...
                                            <input type="text" name="nombreUser" id="nombreUser" value="<%=name %>" placeholder="Nombre" required="" pattern="[a-zA-Z\s]{3,40}" />
                                        </div>
                                        <div class="10u">
                                             <small id="ayudaApellido" class="form-text text-muted">
                                                    Apellidos
                                            </small>
                                            <input type="text" name="apellidoUser" id="apellidoUser" value="<%=apelli %>" placeholder="Apellidos" required="" pattern="[a-zA-Z\s]{3,40}"/>
                                        </div>  
                                        <div class="10u">
                                            <small id="ayudaRun" class="form-text text-muted">
                                                    Run
                                            </small>
                                            <input type="text" name="runUser" id="runUser" value="<%=rune %><" placeholder="Run" pattern="\d{2}[\.]\d{3}[\.]\d{3}[\-]\d{1}" required="" maxlength="12" title="Seguir el formato solicitado: xx.xxx.xxx-x"/>
                                        ...
                                        <div class="10u">
                                            ...
                                            <input type="text" name="celularUser" id="celularUser" value="<%=celu %>" placeholder="Teléfono contacto" pattern="[\+][\(]\d{3}[\)]\d{8}" required="" title="Seguir el formato solicitado: +(569)xxxxxxxx"/>
                                        ...
                                        <div class="10u">
                                            ...
                                            <input type="email" name="correoUser" id="correoUser" value="<%=email %>" placeholder="Correo" required=""/>
                                        </div> 
                                ...
                                <article> 
                                    ...
                                    <div class="row uniform">
                                        <div class="10u">
                                            ...
                                            <input type="text" name="passUser1" id="passUser1" value="<%=passe %>" placeholder="Contraseña" required pattern="[A-Za-z0-9]{5,20}"/>
                                        ...
                                        <div class="10u">
                                            ...
                                            <input type="text" name="passUser2" id="passUser2" value="<%=passe %>" placeholder="Contraseña" onblur="validarPass()" required pattern="[A-Za-z0-9]{5,20}"/>
                                        </div>  
                                    </div>
                                    <br>
                                    <!-- Break -->
